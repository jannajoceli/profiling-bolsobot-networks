...
username = "username" # change username here or run as python lookup.py -u username
...
def look(username):
    ...
    headers = {
        ...
        #'authorization': 'Bearer AAAAAAAAAAAAAAAAAAAAAEfeWQEAAAAA79mmINHRP%2B1QhrIV%2BCFcTKDfHYU%3DGY6oxdK5xvWVzyEiq1ScTVS5NWV1eWqEvwPXxshCEFqXYk7AX6',
    ...
    try:
        print("Username unavailable since " + resp["data"]["user"]["legacy"]["created_at"]["bio"]["follower"])
    except:
        try:
